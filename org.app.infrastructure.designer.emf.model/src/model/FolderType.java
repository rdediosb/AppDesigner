 ...
 * <!-- end-user-doc -->
 * @see model.ModelPackage#getFolderType()
 * @model
 * @generated
 */
public enum FolderType implements Enumerator {
	 ...
	 * @ordered
	 */
	TECHNOLOGY(3, "technology", "technology"),
	 ...
	 * @ordered
	 */
	CONNECTORS(4, "connectors", "connectors"),
	 ...
	 * @ordered
	 */
	RELATIONS(5, "relations", "relations"),
	 ...
	 * @ordered
	 */
	IMPLEMENTATION_MIGRATION(9, "implementation_migration", "implementation_migration");
