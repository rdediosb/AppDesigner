 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.InfrastructureInterfaceImpl#getInterfaceType <em>Interface Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InfrastructureInterfaceImpl extends ArchimateElementImpl implements InfrastructureInterface {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.INFRASTRUCTURE_INTERFACE;
	}
	...
	public void setInterfaceType(int newInterfaceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INFRASTRUCTURE_INTERFACE__INTERFACE_TYPE, oldInterfaceType, interfaceType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.INFRASTRUCTURE_INTERFACE__INTERFACE_TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == InterfaceElement.class) {
			switch (derivedFeatureID) {
				case ModelPackage.INFRASTRUCTURE_INTERFACE__INTERFACE_TYPE: return ModelPackage.INTERFACE_ELEMENT__INTERFACE_TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == InterfaceElement.class) {
			switch (baseFeatureID) {
				case ModelPackage.INTERFACE_ELEMENT__INTERFACE_TYPE: return ModelPackage.INFRASTRUCTURE_INTERFACE__INTERFACE_TYPE;
				default: return -1;
			}
		}
