 ...
 * </p>
 * <ul>
 *   <li>{@link model.impl.DiagramModelBendpointImpl#getStartX <em>Start X</em>}</li>
 *   <li>{@link model.impl.DiagramModelBendpointImpl#getStartY <em>Start Y</em>}</li>
 *   <li>{@link model.impl.DiagramModelBendpointImpl#getEndX <em>End X</em>}</li>
 *   <li>{@link model.impl.DiagramModelBendpointImpl#getEndY <em>End Y</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiagramModelBendpointImpl extends MinimalEObjectImpl.Container implements DiagramModelBendpoint {
	/**
	 ...
	 * @generated
	 */
	protected DiagramModelBendpointImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.DIAGRAM_MODEL_BENDPOINT;
	}
	...
	public void setStartX(int newStartX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DIAGRAM_MODEL_BENDPOINT__START_X, oldStartX, startX));
	}
	...
	public void setStartY(int newStartY) {
		...
		startY = newStartY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DIAGRAM_MODEL_BENDPOINT__START_Y, oldStartY, startY));
	}
	...
	public void setEndX(int newEndX) {
		...
		endX = newEndX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DIAGRAM_MODEL_BENDPOINT__END_X, oldEndX, endX));
	}
	...
	public void setEndY(int newEndY) {
		...
		endY = newEndY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.DIAGRAM_MODEL_BENDPOINT__END_Y, oldEndY, endY));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ModelPackage.DIAGRAM_MODEL_BENDPOINT___GET_COPY:
				return getCopy();
		}
