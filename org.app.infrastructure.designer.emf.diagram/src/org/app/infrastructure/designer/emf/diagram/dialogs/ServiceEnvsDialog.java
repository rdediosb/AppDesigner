...
public class ServiceEnvsDialog extends ContainerPropertyDialog{

	private Text text;
	private Table table;
	private Button btnSearch;
	  
	public ServiceEnvsDialog(Shell parentShell, Service srv) {
	...
	protected Control createDialogArea(Composite parent) {
		...
		grpServiceConfiguration.setText("Set Environment Variables");
