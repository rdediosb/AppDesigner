 ...
 * @generated
 */
public class ContainersViewProvider extends AbstractProvider implements IViewProvider {
	...
	*/
	protected boolean provides(CreateDiagramViewOperation op) {
		return ComposeEditPart.MODEL_ID.equals(op.getSemanticHint())
				&& ContainersVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	*/
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ContainersVisualIDRegistry.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = ContainersVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!ContainersElementTypes.isKnownElementType(elementType)
				...
				if (!ComposeEditPart.MODEL_ID.equals(ContainersVisualIDRegistry.getModelID(op.getContainerView()))) {
	...
	*/
	protected boolean provides(CreateEdgeViewOperation op) {
		IElementType elementType = getSemanticElementType(op.getSemanticAdapter());
		if (!ContainersElementTypes.isKnownElementType(elementType) || (!(elementType instanceof IHintedType))) {
			return false; // foreign element type
		}
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		...
		int visualID = ContainersVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null && visualID != ContainersVisualIDRegistry.getLinkWithClassVisualID(domainElement)) {
	...
	*/
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(ComposeEditPart.MODEL_ID);
	...
	*/
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		if (semanticHint == null) {
			visualID = ContainersVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		} else {
			visualID = ContainersVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ServiceEditPart.VISUAL_ID:
	...
	* @generated
	*/
	public Node createService_2001(EObject domainElement, View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ContainersVisualIDRegistry.getType(ServiceEditPart.VISUAL_ID));
	...
	*/
	public Edge createServiceLink_4001(View containerView, int index, boolean persisted,
		...
		edge.setType(ContainersVisualIDRegistry.getType(ServiceLinkEditPart.VISUAL_ID));
	...
	*/
	private void stampShortcut(View containerView, Node target) {
		if (!ComposeEditPart.MODEL_ID.equals(ContainersVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put("modelID", ComposeEditPart.MODEL_ID); //$NON-NLS-1$
