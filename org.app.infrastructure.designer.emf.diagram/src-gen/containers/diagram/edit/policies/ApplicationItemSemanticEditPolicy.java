 ...
 * @generated
 */
public class ApplicationItemSemanticEditPolicy extends ContainersBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ApplicationItemSemanticEditPolicy() {
		super(ContainersElementTypes.Application_2002);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ContainersVisualIDRegistry.getVisualID(incomingLink) == ServiceAppEditPart.VISUAL_ID) {
