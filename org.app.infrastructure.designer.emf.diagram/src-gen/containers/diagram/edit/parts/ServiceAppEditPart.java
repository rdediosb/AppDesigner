...
public class ServiceAppEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	*/
	...
	protected Connection createConnectionFigure() {
		return new ServiceLinkFigure();
	}

	/**
	* @generated
	*/
	public ServiceLinkFigure getPrimaryShape() {
		return (ServiceLinkFigure) getFigure();
	}

	/**
	 * @generated
	 */
	public class ServiceLinkFigure extends PolylineConnectionEx {

		/**
		 * @generated
		 */
		public ServiceLinkFigure() {
			this.setLineWidth(2);
