...
public class ApplicationEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ApplicationNameEditPart) {
			((ApplicationNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureApplicationName());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ContainersVisualIDRegistry.getType(ApplicationNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class ApplicationFigure extends SVGFigure {

		/**
		* @generated
		*/
		private WrappingLabel fFigureApplicationName;
		...
		* @generated
		*/
		public WrappingLabel getFigureApplicationName() {
			return fFigureApplicationName;
		}
