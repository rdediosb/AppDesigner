...
import containers.components.ServicePropertiesEditionComponent;
...
public class ServicePropertiesEditionProvider extends PropertiesEditingProviderImpl {
	...
	public boolean provides(PropertiesEditingContext editingContext) {
		return (editingContext.getEObject() instanceof Service) 
					&& (ContainersPackage.Literals.SERVICE == editingContext.getEObject().eClass());
	}
	...
	public static class EditionFilter implements IFilter {
		...
		public boolean select(Object toTest) {
			...
			return eObj != null && ContainersPackage.Literals.SERVICE == eObj.eClass();
		}
