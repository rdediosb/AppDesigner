...
public class NamedElementPropertiesEditionComponent extends SinglePartPropertiesEditingComponent {
	...
	public NamedElementPropertiesEditionComponent(PropertiesEditingContext editingContext, EObject namedElement, String editing_mode) {
		...
		partKey = ContainersViewsRepository.NamedElement.class;
	}
	...
	public void initPart(Object key, int kind, EObject elt, ResourceSet allResource) {
		...
		if (editingPart != null && key == partKey) {
			...
			// init values
			if (isAccessible(ContainersViewsRepository.NamedElement.Properties.name))
	...
	public EStructuralFeature associatedFeature(Object editorKey) {
		if (editorKey == ContainersViewsRepository.NamedElement.Properties.name) {
	...
	public void updateSemanticModel(final IPropertiesEditionEvent event) {
		...
		if (ContainersViewsRepository.NamedElement.Properties.name == event.getAffectedEditor()) {
	...
	public void updatePart(Notification msg) {
		...
		if (editingPart.isVisible()) {
			...
			if (ContainersPackage.eINSTANCE.getNamedElement_Name().equals(msg.getFeature()) && msg.getNotifier().equals(semanticObject) && basePart != null && isAccessible(ContainersViewsRepository.NamedElement.Properties.name)) {
