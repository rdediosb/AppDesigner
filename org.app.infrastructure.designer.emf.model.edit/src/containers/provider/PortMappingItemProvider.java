...
/**
 * This is the item provider adapter for a {@link containers.PortMapping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortMappingItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortMapping_external_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortMapping_external_feature", "_UI_PortMapping_type"),
				 ContainersPackage.Literals.PORT_MAPPING__EXTERNAL,
				 true,
				 false,
				 false,
	...
	protected void addInternalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortMapping_internal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortMapping_internal_feature", "_UI_PortMapping_type"),
				 ContainersPackage.Literals.PORT_MAPPING__INTERNAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		PortMapping portMapping = (PortMapping)object;
		return getString("_UI_PortMapping_type") + " " + portMapping.getExternal();
	}
