...
/**
 * This is the item provider adapter for a {@link containers.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends NamedElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Image_imageID_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Image_imageID_feature", "_UI_Image_type"),
				 ContainersPackage.Literals.IMAGE__IMAGE_ID,
				 true,
				 false,
				 false,
