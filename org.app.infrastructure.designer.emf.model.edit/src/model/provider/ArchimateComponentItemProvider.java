...
/**
 * This is the item provider adapter for a {@link model.ArchimateComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchimateComponentItemProvider 
	 ...
	 * @generated
	 */
	public ArchimateComponentItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ArchimateComponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArchimateComponent_type") :
			getString("_UI_ArchimateComponent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArchimateComponent.class)) {
