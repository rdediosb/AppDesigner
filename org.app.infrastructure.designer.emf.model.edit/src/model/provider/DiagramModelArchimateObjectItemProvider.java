...
/**
 * This is the item provider adapter for a {@link model.DiagramModelArchimateObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelArchimateObjectItemProvider extends DiagramModelObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelArchimateObject_archimateElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelArchimateObject_archimateElement_feature", "_UI_DiagramModelArchimateObject_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_ARCHIMATE_OBJECT__ARCHIMATE_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelArchimateObject_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelArchimateObject_type_feature", "_UI_DiagramModelArchimateObject_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_ARCHIMATE_OBJECT__TYPE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DiagramModelArchimateObject"));
	}
	...
	public String getText(Object object) {
		String label = ((DiagramModelArchimateObject)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelArchimateObject_type") :
			getString("_UI_DiagramModelArchimateObject_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramModelArchimateObject.class)) {
