...
/**
 * This is the item provider adapter for a {@link model.DiagramModelConnection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelConnectionItemProvider extends DiagramModelComponentItemProvider {
	/**
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelConnection_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelConnection_text_feature", "_UI_DiagramModelConnection_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__TEXT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTextPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelConnection_textPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelConnection_textPosition_feature", "_UI_DiagramModelConnection_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__TEXT_POSITION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelConnection_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelConnection_source_feature", "_UI_DiagramModelConnection_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelConnection_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelConnection_target_feature", "_UI_DiagramModelConnection_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DiagramModelConnection_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DiagramModelConnection_type_feature", "_UI_DiagramModelConnection_type"),
				 ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__BENDPOINTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DiagramModelConnection"));
	}
	...
	public String getText(Object object) {
		String label = ((DiagramModelConnection)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelConnection_type") :
			getString("_UI_DiagramModelConnection_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramModelConnection.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.DIAGRAM_MODEL_CONNECTION__BENDPOINTS,
