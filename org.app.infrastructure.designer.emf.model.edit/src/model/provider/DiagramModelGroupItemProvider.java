...
/**
 * This is the item provider adapter for a {@link model.DiagramModelGroup} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelGroupItemProvider extends DiagramModelObjectItemProvider {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DiagramModelGroup"));
	}
	...
	public String getText(Object object) {
		String label = ((DiagramModelGroup)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelGroup_type") :
			getString("_UI_DiagramModelGroup_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramModelGroup.class)) {
