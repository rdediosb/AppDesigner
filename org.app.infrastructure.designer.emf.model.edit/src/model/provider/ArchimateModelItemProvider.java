...
/**
 * This is the item provider adapter for a {@link model.ArchimateModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArchimateModelItemProvider 
	...
	protected void addPurposePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArchimateModel_purpose_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArchimateModel_purpose_feature", "_UI_ArchimateModel_type"),
				 ModelPackage.Literals.ARCHIMATE_MODEL__PURPOSE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addFilePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArchimateModel_file_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArchimateModel_file_feature", "_UI_ArchimateModel_type"),
				 ModelPackage.Literals.ARCHIMATE_MODEL__FILE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ArchimateModel_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ArchimateModel_version_feature", "_UI_ArchimateModel_type"),
				 ModelPackage.Literals.ARCHIMATE_MODEL__VERSION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.ARCHIMATE_MODEL__METADATA);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ArchimateModel"));
	}
	...
	public String getText(Object object) {
		String label = ((ArchimateModel)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ArchimateModel_type") :
			getString("_UI_ArchimateModel_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ArchimateModel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.ARCHIMATE_MODEL__METADATA,
