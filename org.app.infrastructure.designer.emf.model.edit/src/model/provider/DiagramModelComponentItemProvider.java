...
/**
 * This is the item provider adapter for a {@link model.DiagramModelComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramModelComponentItemProvider 
	...
	public String getText(Object object) {
		String label = ((DiagramModelComponent)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DiagramModelComponent_type") :
			getString("_UI_DiagramModelComponent_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramModelComponent.class)) {
