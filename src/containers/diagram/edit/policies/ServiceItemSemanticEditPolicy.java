 ...
 * @generated
 */
public class ServiceItemSemanticEditPolicy extends ContainersBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ServiceItemSemanticEditPolicy() {
		super(ContainersElementTypes.Service_2001);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ContainersVisualIDRegistry.getVisualID(incomingLink) == ServiceLinkEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ContainersVisualIDRegistry.getVisualID(outgoingLink) == ServiceLinkEditPart.VISUAL_ID) {
